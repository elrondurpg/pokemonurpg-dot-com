...
app.controller('dexCtrl', ['pokemonService', '$location', '$rootScope', '$window', function(pokemonService, $location, $rootScope, $window) {
    var ctrl = this;
    ...
    pokemonService.findByName(regex[1])
        .then(function(pokemon) {
            console.log(pokemon);
            ctrl.pokemon = pokemon;
            for (var i = 0; i < pokemon.alteredForms.length; i++)
            {
            ...
            if (pokemon.currentForm === undefined)
...
app.directive('pokemon', function() {
    return {
        restrict: 'E',
        templateUrl: "/ultradex/partials/pokemon.html"
    };
});
...
app.directive('dexHeader', function() {
    return {
        restrict: 'E',
        templateUrl: "/ultradex/partials/dex-header.html"
    };
});
...
app.directive('dexBody', function() {
   return {
       restrict: 'E',
       templateUrl: '/ultradex/partials/dex-body.html'
   };
});
...
app.directive('dexInfo', function() {
    return {
        restrict: 'E', 
        templateUrl: '/ultradex/partials/dex-info.html'
    };
});
...
app.directive('pokemonSprite', function() {
   return {
       restrict: 'E',
       templateUrl: '/ultradex/partials/pokemon-sprite.html'
   };
});
...
app.directive('pokemonDexInfo', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/pokemon-dex-info.html'
    }; 
});
...
app.directive('abilityInfo', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/ability-info.html'
    };
});
...
app.directive('statsInfo', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/stats-info.html'
    }; 
});
...
app.directive('formTabs', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/form-tabs.html'
    }; 
});
...
app.directive('typeMatchups', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/type-matchups.html'
    };
});
...
app.directive('miscInfo', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/misc-info.html'
    };
});
...
app.directive('evolutionFamily', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/evolution-family.html'
    };
});
...
app.directive('captureInfo', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/capture-info.html'
    }; 
});
...
app.directive('learnset', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/learnset.html'
    };
});
...
app.directive('megaEvolutions', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/partials/mega-evolutions.html'
    };
});
...
app.directive('megaTabs', function() {
    return {
        restrict: 'E', 
        templateUrl: '/ultradex/partials/mega-tabs.html'
    };
});
...
app.directive('formInfo', function() {
    return {
        restrict: 'E', 
        templateUrl: '/ultradex/partials/form-info.html'
    };
});
...
app.directive('moveHints', function() {
    return {
        restrict: 'E',
        templateUrl: '/ultradex/modals/move-hints.html'
    }
})